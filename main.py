...
def open_image(filename):
    ...
    previous_state = image_atual.copy()  # Save the original state
...
def apply_gray_filter():
    ...
    if image_atual:
        ...
        previous_state = image_atual.copy()  # Save the state before applying the filter
...
while True:
    ...
    if event in (sg.WINDOW_CLOSED, 'Fechar'):
        ...
        sg.popup('Desenvolvido por Gustavo Piroupo Neumann - BCC 6º Semestre')
